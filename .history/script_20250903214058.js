...
function renderRoutine() {
  ...
  // প্রতিদিনের সর্বোচ্চ ক্লাস সংখ্যা বের করা
  let maxClasses = 0;
  ...
  daysOrder.forEach(day => {
    ...
    if (routineData[day]) {
      ...
      // যদি ওই দিনের ক্লাস সংখ্যা কম হয়, বাকি ঘর খালি থাকবে
      let empty = maxClasses - routineData[day].length;
      for (let i = 0; i < empty; i++) {
        html += "<td></td>";
      }
    } else {
      // যদি ওই দিনে কোনো ক্লাসই না থাকে → পুরো row ফাঁকা

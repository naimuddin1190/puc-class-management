...
.admin-panel input, .admin-panel select, .admin-panel textarea { margin:6px 6px 6px 0; padding:8px; border-radius:8px; border:1px solid #444; background:#0b1020; color:var(--text); width:100%; }
...
<?php else: foreach($notices as $n): ?>
  <div class="res-item">
    ...
    <?php if(!empty($_SESSION['is_cr'])): ?>
      <form class="res-actions" method="post" action="notice_delete.php" onsubmit="return confirm('Delete this notice?');">

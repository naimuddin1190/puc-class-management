...
<head>
  ...
  <style>
    /* Font Fixes: Black & Bold */
    body, h1, h2, h3, h4, h5, h6, p, a, li, input, textarea, button {
        color: #000 !important;
        font-weight: 600 !important;
        opacity: 1 !important;
    }
    .nav .menu a, .footer p, .footer .socials a {
    ...
    .admin-btn {display:block; width:220px; margin:20px auto; padding:12px; background:#28a745; color:#fff; text-align:center; border-radius:8px; text-decoration:none; font-weight:600;}
